var doc = (0,eval)("document");
var win = (0,eval)("window");

var TextInput = function(x,y,style){
    if(typeof style === "undefined"){
        style = {};
    }
    
    TextInput.ctx = (0,eval)("document.getElementById('output-canvas')").getContext("2d");
    ...
    TextInput.nextFrame = function(){
        TextInput.requestingHover = false;
        TextInput.mouseClicked = false;
        TextInput.mouseMoved = false;
    };
    TextInput.IGNORE_LIST = ["Control","Alt","Shift","Enter","Escape","CapsLock","Meta","PageUp","PageDown","F1","F2","F3","F4","F5","F6","F7","F8","F9","F10","F11","F12","Home","End","Insert","Tab"];
    TextInput.restrain = function(val,min,max){
        return(val < min ? min : (val > max ? max : val));
    };
    TextInput.roundedRect = function(ctx,x,y,w,h,r1,r2,r3,r4){
...
TextInput.prototype.setValue = function(newValue){
...
TextInput.prototype.undo = function(){
    if(this.undoIndex === 0){
        return;
    }
    this.undoIndex--;
...
TextInput.prototype.redo = function(){
    if(this.undoIndex >= this.undos.length){
        return;
    }
    this.undoIndex++;
...
TextInput.prototype.handleKeypress = function(key){
...
TextInput.prototype.solveSelectedStyle = function(style){
    ...
    if(this.isMouseInside()){
        if(TextInput.mouseClicked){
            ...
            if(!this.selected && this.highlightAllTextWhenSelected){
                ...
                var xin = (mouseX - this.x - this.textSize * 0.1) + this.scroll;
                if(xin > w){
                    this.insertingAt = this.value.length;
...
TextInput.prototype.isMouseInside = function(){
    return(mouseX > this.x && mouseX < this.x + this.width && mouseY > this.y && mouseY < this.y + this.height);
};
TextInput.prototype.onselect = function(){

};
TextInput.prototype.onunselect = function(){

};
TextInput.prototype.onkeypress = function(e){

};
TextInput.prototype.onkeyrelease = function(e){

};
TextInput.prototype.onenter = function(){

};
TextInput.prototype.oncopy = function(){

};
TextInput.prototype.onpaste = function(e){

};
TextInput.prototype.setStyle = function(obj){
